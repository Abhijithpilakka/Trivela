  ...
  return (
    <div className="min-h-screen bg-pitch pt-24 pb-20 px-4 sm:px-6">
      <div className="max-w-4xl mx-auto text-center">
        <div className="mb-8">
          <Zap className="w-16 h-16 text-gold mx-auto mb-4" />
        ...
        <div className="bg-night border border-border rounded-lg p-8 max-w-md mx-auto">
          ...
          <p className="text-muted">
            Football Trivia is currently being built. Check back soon for challenging questions about your favorite teams and players!
          </p>
        </div>
      </div>
    </div>
